...
class InstanceType(BaseModel):
    ...
    gpu_description: StrictStr = Field(description="Description of the GPU(s) in the instance type")
    price_cents_per_hour: StrictInt = Field(description="Price of the instance type, in US cents per hour")
    specs: InstanceTypeSpecs
    __properties: ClassVar[List[str]] = ["name", "description", "gpu_description", "price_cents_per_hour", "specs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gpu_description": obj.get("gpu_description"),
            "price_cents_per_hour": obj.get("price_cents_per_hour"),
            "specs": InstanceTypeSpecs.from_dict(obj["specs"]) if obj.get("specs") is not None else None
        })
        return _obj
