...
class Error(BaseModel):
    ...
    suggestion: Optional[StrictStr] = Field(default=None, description="Suggestion of possible ways to fix the error.")
    __properties: ClassVar[List[str]] = ["code", "message", "suggestion"]
