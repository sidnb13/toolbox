...
class InstanceTypes200Response(BaseModel):
    """
    InstanceTypes200Response
    """ # noqa: E501
    data: Dict[str, InstanceTypes200ResponseDataValue] = Field(description="Dict of instance_type_name to instance_type and region availability.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": dict(
                (_k, InstanceTypes200ResponseDataValue.from_dict(_v))
