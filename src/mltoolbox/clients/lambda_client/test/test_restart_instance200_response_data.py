...
class TestRestartInstance200ResponseData(unittest.TestCase):
    """RestartInstance200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestartInstance200ResponseData:
        """Test RestartInstance200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestartInstance200ResponseData`
        """
        model = RestartInstance200ResponseData()
        if include_optional:
    ...
    def testRestartInstance200ResponseData(self):
        """Test RestartInstance200ResponseData"""
